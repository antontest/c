...
int main(int argc, char *argv[])
{
  ...
  curl_formadd(&formpost,
               ...
               CURLFORM_COPYCONTENTS, "/home/anton/ipsec/req/anton/anton_req.pem",
               CURLFORM_END);
  ...
  /* Fill in the submit field too, even if this is rarely needed */ 
    ...
    if(curl) {
        ...
        curl_easy_setopt(curl, CURLOPT_SSLCERT, "/home/anton/ftp/file.crt.pem"); 
        curl_easy_setopt(curl, CURLOPT_SSLKEY, "/home/anton/ftp/file.key.pem"); 
        curl_easy_setopt(curl, CURLOPT_CAPATH, "/home/anton/ftp");
        curl_easy_setopt(curl, CURLOPT_CAINFO, "file.crt.pem");
        curl_easy_setopt(curl, CURLOPT_SSL_VERIFYPEER, 0L);
        curl_easy_setopt(curl, CURLOPT_SSL_VERIFYHOST, 0L);
        curl_easy_setopt(curl, CURLOPT_WRITEFUNCTION, 0L);
